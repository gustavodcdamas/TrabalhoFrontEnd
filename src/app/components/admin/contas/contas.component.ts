...
import { faFilter, faMagnifyingGlass, faPen, faTrash  } from '@fortawesome/free-solid-svg-icons';
...
export class ContasComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, library: FaIconLibrary) {
    ...
    library.addIcons(faFacebook, faLinkedinIn,
    faInstagram, faAngular,
    faWhatsapp, faMagnifyingGlass,
    faPen, faFilter, faTrash
   );
  }
